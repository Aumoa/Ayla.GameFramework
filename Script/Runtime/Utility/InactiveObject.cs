...
namespace Ayla
{
    public static class InactiveObject
    {
        ...
        public static async UniTask<T[]> InstantiateAsync<T>(T original, CancellationToken cancellationToken = default) where T : Component
        {
        ...
        public static async UniTask<T[]> InstantiateAsync<T>(T original, int count, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, count, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, Transform parent, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, parent, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, int count, Transform parent, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, count, parent, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, Vector3 position, Quaternion rotation, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, position, rotation, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, int count, Vector3 position, Quaternion rotation, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, count, position, rotation, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, Vector3[] positions, Quaternion[] rotations, CancellationToken cancellationToken = default) where T : Component
        {
            var gameObjects = await InstantiateAsync(original.gameObject, positions, rotations, cancellationToken);
            return gameObjects.Select(p => p.GetComponent<T>()).ToArray();
        }

        public static async UniTask<T[]> InstantiateAsync<T>(T original, int count, Vector3[] positions, Quaternion[] rotations, CancellationToken cancellationToken = default) where T : Component
        {
        ...
        public static UniTask<GameObject[]> InstantiateAsync(GameObject original, CancellationToken cancellationToken = default)
        {
            return InstantiateAsync(original, 1, cancellationToken);
        }

        public static async UniTask<GameObject[]> InstantiateAsync(GameObject original, int count, CancellationToken cancellationToken = default)
        {
            InitializeOnDemand();
        ...
        public static UniTask<GameObject[]> InstantiateAsync(GameObject original, Transform parent, CancellationToken cancellationToken = default)
        {
            return InstantiateAsync(original, 1, parent, cancellationToken);
        }

        public static async UniTask<GameObject[]> InstantiateAsync(GameObject original, int count, Transform parent, CancellationToken cancellationToken = default)
        {
            InitializeOnDemand();
            using var template = new InactiveObjectLoader(original);
        ...
        public static UniTask<GameObject[]> InstantiateAsync(GameObject original, Vector3 position, Quaternion rotation, CancellationToken cancellationToken = default)
        {
            return InstantiateAsync(original, 1, position, rotation, cancellationToken);
        }

        public static async UniTask<GameObject[]> InstantiateAsync(GameObject original, int count, Vector3 position, Quaternion rotation, CancellationToken cancellationToken = default)
        {
            InitializeOnDemand();
            using var template = new InactiveObjectLoader(original);
        ...
        public static UniTask<GameObject[]> InstantiateAsync(GameObject original, Vector3[] positions, Quaternion[] rotations, CancellationToken cancellationToken = default)
        {
            return InstantiateAsync(original, 1, positions, rotations, cancellationToken);
        }

        public static UniTask<GameObject[]> InstantiateAsync(GameObject original, int count, ReadOnlySpan<Vector3> positions, ReadOnlySpan<Quaternion> rotations, CancellationToken cancellationToken = default)
        {
            ...
            async UniTask<GameObject[]> InternalAsync()
            {
